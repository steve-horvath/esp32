...
const PROGMEM char* MQTT_CLIENT_ID = "test_dht22";
const PROGMEM char* MQTT_SERVER_IP = "192.168.1.243";
const PROGMEM uint16_t MQTT_SERVER_PORT = 1883;
const PROGMEM char* MQTT_USER = "sensor";
const PROGMEM char* MQTT_PASSWORD = "sensor";

// MQTT: topic
const PROGMEM char* MQTT_SENSOR_TOPIC = "DHT/sensor1";
